...
namespace BlogApi.BussinssLogic
{
    ...
    public interface IBlogsLogic
    {
        ...
        public Task<(bool success, List<string> Errors)> UpdateBlog(updateBlogDto updateblogdto, string username);
    ...
    public class BlogsLogic:IBlogsLogic
    {
        ...
        public async Task<(bool success, List<string> Errors)> UpdateBlog(updateBlogDto updateblogdto, string username)
        {
            Blogs blog = await _context.blogs.FirstOrDefaultAsync(b => b.id == updateblogdto.blogId);
